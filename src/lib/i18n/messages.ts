...
export const messages = {
  pt: {
    ...
    "settings.backupAutoDesc":
      "O sistema gera um backup no servidor e mantém apenas um arquivo atualizado (o anterior é substituído).",
  ...
  en: {
    ...
    "settings.backupAutoDesc":
      "The system generates a backup on the server and keeps only one updated file (the previous one is replaced).",
  ...
  es: {
    ...
    "settings.backupAutoDesc":
      "El sistema genera un respaldo en el servidor y mantiene solo un archivo actualizado (el anterior se reemplaza).",
