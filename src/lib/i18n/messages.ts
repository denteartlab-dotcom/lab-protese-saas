...
export const messages = {
  pt: {
    ...
    "settings.backupAutoDesc":
      "O sistema grava os backups na pasta backups/ do servidor, em arquivos com a data no nome.",
  ...
  en: {
    ...
    "settings.backupAutoDesc":
      "The system saves backups in the server backups/ folder, in files named with the date.",
  ...
  es: {
    ...
    "settings.backupAutoDesc":
      "El sistema guarda los respaldos en la carpeta backups/ del servidor, en archivos con la fecha en el nombre.",
