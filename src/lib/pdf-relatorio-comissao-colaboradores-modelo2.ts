...
function colunasComissaoModelo2(): ColunaComissaoPdf[] {
  return [
...
export async function gerarRelatorioComissaoColaboradoresModelo2Pdf(
  linhas: LinhaComissaoColaborador[],
  ...
  const colunas = escalarColunasParaPaginaA4(colunasComissaoModelo2(), larguraUtil);
