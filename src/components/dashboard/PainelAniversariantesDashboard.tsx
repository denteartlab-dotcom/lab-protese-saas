...
export function PainelAniversariantesDashboard({
  ...
  function imprimirPdf() {
    ...
    const linhas = filtrados
      ...
      .join("");
    const html = `<!DOCTYPE html><html><head><meta charset="utf-8"/><title>Aniversariantes ${tituloMes}</title>
      ...
      <body><h1>Aniversariantes — ${tituloMes}</h1><table><thead><tr><th>Cliente</th><th>Nascimento</th><th>Dia</th></tr></thead><tbody>${linhas || "<tr><td colspan=3>Nenhum aniversariante</td></tr>"}</tbody></table></body></html>`;
      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            <p className="text-xs text-slate-500">Envie uma mensagem especial</p>
            {mostrarBusca && (
