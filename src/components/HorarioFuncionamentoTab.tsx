...
export function HorarioFuncionamentoTab({ onMensagem }: Props) {
  ...
  function adicionarFeriado() {
    if (!config || !novoFeriado.data.trim()) return;
  ...
  const diaIntervalo =
    diaIntervaloIdx !== null ? config.dias[diaIntervaloIdx] : null;
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNovoFeriado((f) => ({ ...f, data: e.target.value }))
                }
            ...
            <Input
              ...
              onChange={(e) =>
                setNovoFeriado((f) => ({ ...f, descricao: e.target.value }))
              }
          ...
          <div className="flex justify-end gap-2 border-t border-slate-100 pt-4">
            <Button
              ...
              onClick={() => {
                ...
                onMensagem?.("Feriados gravados.", "sucesso");
              }}
            >
...
function ModalIntervalos({
  ...
  return (
    <Modal open onClose={onClose} title={`Intervalos — ${dia.label}`} size="md">
      ...
      <div className="space-y-3">
        {lista.map((item, idx) => (
          ...
          >
            <span className="w-full text-[11px] font-medium text-slate-600">
              Intervalo {idx + 1}
            </span>
